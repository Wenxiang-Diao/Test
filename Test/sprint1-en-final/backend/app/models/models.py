...
class Resident(Base):
    ...
    daily_habits: Mapped[str | None] = mapped_column(Text, nullable=True)
    care_notes: Mapped[str | None] = mapped_column(Text, nullable=True)
    monitoring_status: Mapped[str] = mapped_column(String(24), default="ACTIVE", nullable=False)
    ...
    floor_level: Mapped[str | None] = mapped_column(String(32), nullable=True)
    location_notes: Mapped[str | None] = mapped_column(Text, nullable=True)
    transfer_destination: Mapped[str | None] = mapped_column(String(128), nullable=True)
