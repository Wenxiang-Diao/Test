...
from app.analytics.bed_exit_logistic import (  # noqa: E402
    build_logistic_dataset,
    train_logistic_models,
)
from app.analytics.bed_exit_xgboost import split_train_validation, summarise_split  # noqa: E402


def main() -> None:
    parser = argparse.ArgumentParser(description="Train baseline-rules + logistic bed-exit prediction models.")
    parser.add_argument(
        "--input-dir",
    ...
    parser.add_argument(
        "--model-dir",
        default=str(ROOT / "artifacts" / "bed_exit_logistic"),
        help="Directory where trained Logistic Regression models and reports are written.",
    )
    parser.add_argument(
        "--validation-start",
        default="2026-06-03",
    ...
    dataset = build_logistic_dataset(args.input_dir)
    ...
    training_report = train_logistic_models(train, validation, model_dir)
